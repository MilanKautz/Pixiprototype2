...
})({"y71rS":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "6cd8814b773371ca";
...
},{}],"2eOQ3":[function(require,module,exports) {
...
let menuSong = new Audio((0, _songMp3Default.default));
let menuSound = new Audio((0, _menuMp3Default.default));
let menuScrolling = new Audio((0, _menuscrollMp3Default.default));
menuSong.volume = 0.4;
...
},{"url:../sound/menu.mp3":"XvYHC","url:../sound/menuscroll.mp3":"fD7oX","url:../sound/song.mp3":"e9mPD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"XvYHC":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("9lnL8") + "menu.1177aa66.mp3" + "?" + Date.now();
...
},{}],"fD7oX":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("9lnL8") + "menuscroll.c1a8fd22.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"e9mPD":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("9lnL8") + "song.351620fc.mp3" + "?" + Date.now();
...
},{}]},["y71rS","2eOQ3"], "2eOQ3", "parcelRequirea0e5")

//# sourceMappingURL=gameover.773371ca.js.map
